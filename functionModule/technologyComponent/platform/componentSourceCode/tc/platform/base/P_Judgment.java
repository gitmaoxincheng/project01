...
import cn.com.agree.huanan.ap.tl.util.Judgment;
...
public class P_Judgment {					
	...
	public static TCResult boolFrame(Object boolObject) {
		if (!Judgment.boolFrame(boolObject)) {
			return new TCResult(TCResult.STAT_FAILURE);
		}
		return new TCResult(TCResult.STAT_SUCCESS);
	}
	 ...
	 * 		1 成功<br>
	 */
	@InParams(param = { @Param(name = "obj", comment = "需要判断的对象", type = java.lang.Object.class)})
	@Returns(returns = { @Return(id = "0", desp = "失败"), @Return(id = "1", desp = "成功") })
	@Component(label = "判断对象类型", style = "判断型", type = "同步组件", comment = "打印对象类型", date = "2019-07-08 12:18:35")
	public static TCResult P_judgeType(Object obj) { // XXX
        Logger logger = Logger.getLogger(P_Judgment.class);
	 ...
	 *         7 与case7匹配<br/>
	 */
	@InParams(param = { @Param(name = "src", comment = "源匹配字符串", type = java.lang.String.class),
	...
	@Returns(returns = { @Return(id = "0", desp = "失败"), @Return(id = "1", desp = "与case1匹配"),
			@Return(id = "2", desp = "与case2匹配"), @Return(id = "3", desp = "与case3匹配"),
			@Return(id = "4", desp = "与case4匹配"), @Return(id = "5", desp = "与case5匹配"),
			@Return(id = "6", desp = "与case6匹配"), @Return(id = "7", desp = "与case7匹配") })
	@Component(label = "字符串SWITCH匹配", style = "判断型", type = "同步组件", comment = "字符串SWITCH匹配", date = "Wed Jul 22 15:31:54 CST 2015")
	public static TCResult switchCaseFrame(String src, String case1, String case2, String case3, String case4,
			String case5, String case6, String case7) {
		if (src == null) {
