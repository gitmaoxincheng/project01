...
import cn.com.agree.huanan.ap.al.csiusr.dutyinfo.po.DutyInfo.csis_dutyinfo;
...
public class DutyInfo implements Serializable {
	...
	private String authLevel;//智能设备授权等级 0-无授权权限,1-一级授权权限,2-二级授权权限
	private String adminFlg;//是否管理员 0-否1-是
    public static class csis_dutyinfo {
     ...
     * @return DutyInfo
     */
    public static DutyInfo instance(Map<String, Object> map){
    	DutyInfo spb=new DutyInfo();
        ...
        spb.setAuthLevel(map.get("authLevel").toString());
        spb.setAdminFlg(map.get("adminFlg").toString());
        return spb;
    }
    
    public static Map<String, Object> getMap(DutyInfo dutyInfo) {
    	...
    	map.put("authLevel", dutyInfo.getAuthLevel());
