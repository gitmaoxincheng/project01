package cn.com.agree.huanan.ap.al.csiopr.teller.dao;

import java.util.List;
import java.util.Map;

import cn.com.agree.huanan.ap.al.csiopr.teller.po.TellerInfo;
...
public interface TellerDao {
	...
	public int updateTellerInfo(String tellerno);
