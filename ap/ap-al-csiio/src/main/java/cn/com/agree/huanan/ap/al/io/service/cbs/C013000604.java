...
/**
 * BASESVC.C013000604 客户详细信息查询.按客户号查询对公客户信息 
 * C0130006.04 cf4014
 * 0005 新核心系统
 * @author XZF
 */
@Component
public class C013000604 extends EsbCoreChannelService {

	private static C013000604_I i = new C013000604_I();
	private static C013000604_O o = new C013000604_O();
	public C013000604() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class C013000604_I extends MsgBody {
	...
	public static class C013000604_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
					...
					.addNode(new FieldNode("oprn_plc_civil_cptmt_nm", new MsgField(ContentEnum.MessageType.STRING.toString(), "oprn_plc_civil_cptmt_nm", 1500,0, false, "经营地行政区划名称" )))
					...
					.addNode(new FieldNode("ntnlt_full_nm", new MsgField(ContentEnum.MessageType.STRING.toString(), "ntnlt_full_nm", 300,0, false, "国籍全称" )))
					...
					.addNode(new FieldNode("tax_payer_tp", new MsgField(ContentEnum.MessageType.STRING.toString(), "tax_payer_tp", 2,0, false, "纳税人类型" )))
					...
					.addNode(new FieldNode("sprr_corp_org_code", new MsgField(ContentEnum.MessageType.STRING.toString(), "sprr_corp_org_code", 20,0, false, "上级单位组织机构代码" )))
					...
					.addNode(new FieldNode("rgstn_cptl", new MsgField(ContentEnum.MessageType.INT.toString(), "rgstn_cptl", 17,2, false, "注册资金" )))
					.addNode(new FieldNode("actly_rcvd_cptl", new MsgField(ContentEnum.MessageType.INT.toString(), "actly_rcvd_cptl", 17,2, false, "实收资本" )))
					...
					.addNode(new FieldNode("sale_amt", new MsgField(ContentEnum.MessageType.INT.toString(), "sale_amt", 17,2, false, "销售额" )))
