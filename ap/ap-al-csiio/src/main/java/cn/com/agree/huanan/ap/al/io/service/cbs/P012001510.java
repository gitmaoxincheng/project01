...
/**
 * BASESVC.P012001510 存款凭证管理.客户凭证挂失 
 * P0120015.10 ce5126
 * 0064 中间业务平台(东莞社会保障卡模块)
 * @author XZF
 */
@Component
public class P012001510 extends EsbCoreChannelService {

	private static P012001510_I i = new P012001510_I();
	private static P012001510_O o = new P012001510_O();
	public P012001510() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class P012001510_I extends MsgBody {
	...
	public static class P012001510_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
