...
/**
 * BASESVC BODAFA0000_2  安全认证（ARQC验证）
 * BODAFA0000_2 ic1210 204009
 *  综合前置
 * @author YYX
 */
@Component
public class BODAFA0000_2 extends EciChannelService {

	private static BODAFA0000_2_I i = new BODAFA0000_2_I();
	private static BODAFA0000_2_O o = new BODAFA0000_2_O();
	...
	public static class BODAFA0000_2_I extends MsgBody {
	...
	public static class BODAFA0000_2_O extends MsgBody {
		private MsgSegment msgSegment = init();
