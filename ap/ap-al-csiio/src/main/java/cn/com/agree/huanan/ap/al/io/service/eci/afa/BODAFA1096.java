...
@Component
public class BODAFA1096 extends EciChannelService {

	private static BODAFA1096_I i = new BODAFA1096_I();
	private static BODAFA1096_O o = new BODAFA1096_O();
	public BODAFA1096() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODAFA1096_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("brnoname", new MsgField(ContentEnum.MessageType.STRING.toString(), "brnoname", 200, 0, false, "经办网点名称")))
					.addNode(new FieldNode("stmteller", new MsgField(ContentEnum.MessageType.STRING.toString(), "stmteller", 10, 0, false, "STM柜员号")))
					.addNode(new FieldNode("imagenum", new MsgField(ContentEnum.MessageType.STRING.toString(), "imagenum", 2, 0, false, "图像数量")))
					.addNode(new FieldNode("reauthtype", new MsgField(ContentEnum.MessageType.STRING.toString(), "reauthtype", 1, 0, false, "授权类型")))
					.addNode(new ArrayNode("imageList",true)
	...
	public static class BODAFA1096_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
