...
/**
 * BASESVC.C012000109 客户信息管理.客户信息变更申请信息修改 
 * C0120001.09 8819710
 * 0339 综合前置(微网点模块)
 * @author XZF
 */
@Component
public class C012000109 extends EsbChannelService {

	private static C012000109_I i = new C012000109_I();
	private static C012000109_O o = new C012000109_O();
	public C012000109() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class C012000109_I extends MsgBody {
	...
	public static class C012000109_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
