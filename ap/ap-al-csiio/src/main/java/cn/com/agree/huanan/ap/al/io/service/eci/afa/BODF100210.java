...
/**
 * BASESVC BODF100210  定期定额关闭交易 
 *  BODF100210 regflw
 *  综合前置
 * @author XZF
 */
@Component
public class BODF100210 extends EciF10ChannelService {

	private static BODF100210_I i = new BODF100210_I();
	private static BODF100210_O o = new BODF100210_O();
	public BODF100210() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODF100210_I extends MsgBody {
	...
	public static class BODF100210_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
