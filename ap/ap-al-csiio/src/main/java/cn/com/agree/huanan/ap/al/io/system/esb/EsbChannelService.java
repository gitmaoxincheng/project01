 ...
 * json报文
 */
public class EsbChannelService extends IOService {
...
/*	@Override
	public Map<String,Object> buildOutMessageContext(Map<String, Object> tradeContext) {
		getErrorCode(tradeContext);	//特殊处理，因为映射前后ErrorCode ErrorMsg 位置不同了,与super.buildOutMessageContext(tradeContext)顺序不可调换
		getErrorMessage(tradeContext);
