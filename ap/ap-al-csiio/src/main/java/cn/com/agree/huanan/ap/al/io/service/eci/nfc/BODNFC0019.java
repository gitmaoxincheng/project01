...
/**
 * BASESVC BODNFC0019 取现冲正 BODNFC0019 regflw 渠道整合
 * 
 * @author HYS
 */
@Component
public class BODNFC0019 extends EciChannelService {
	/*
	 * 
	 ...
	 * ('BASESVCBODNFC0019', 'BASESVC', '渠道整合', 'BODNFC0019', '', 'ECI.NFC',
	 * 'ECI_NFC系统', 'BODNFC0019', '取现冲正', 'Q105','regflw' ,'', '1', '0', '');
	 * 
	 */
	private static BODNFC0019_I i = new BODNFC0019_I();
	private static BODNFC0019_O o = new BODNFC0019_O();
	...
	public static class BODNFC0019_I extends MsgBody {
	...
	public static class BODNFC0019_O extends MsgBody {
		private MsgSegment msgSegment = init();
			...
			messageNode.addStructNode(new StructNode("Body", true, "APPBody")
					...
					.addNode(new FieldNode("ret_msg",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "ret_msg", 512, 0, false,
									"交易返回信息")))
					.addNode(new FieldNode("accept_branch_id",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "accept_branch_id", 200, 0, false,
									"受理机构代码")))
					.addNode(new FieldNode("settle_field_name",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "settle_field_name", 30, 0, false,
									"清算主键")))
					.addNode(new FieldNode("clear_date",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "clear_date", 4, 0, false, "清算日期")))
					.addNode(new FieldNode("message_type_id",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "message_type_id", 4, 0, false,
									"报文类型标识符")))
					.addNode(new FieldNode("handle_code",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "handle_code", 6, 0, false, "处理码")))
					.addNode(new FieldNode("pos_cond_code",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "pos_cond_code", 2, 0, false,
									"服务点条件码")))
					.addNode(new FieldNode("tran_index_no",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "tran_index_no", 12, 0, false,
									"交易检索号")))
					.addNode(new FieldNode("ex_region_value",
							new MsgField(ContentEnum.MessageType.STRING.toString(), "ex_region_value", 120, 0, false,
									"扩展域值")))
					.addNode(new FieldNode("reserv_field1",
