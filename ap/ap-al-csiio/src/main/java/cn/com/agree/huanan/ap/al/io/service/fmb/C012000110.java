...
/**
 * BASESVC.C012000110 客户信息管理.个人开卡申请信息修改 
 * C0120001.10 8819708
 * 0339 综合前置(微网点模块)
 * @author XZF
 */
@Component
public class C012000110 extends EsbChannelService {

	private static C012000110_I i = new C012000110_I();
	private static C012000110_O o = new C012000110_O();
	public C012000110() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class C012000110_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true)
					...
					.addNode(new FieldNode("TaxSta", new MsgField(ContentEnum.MessageType.STRING.toString(), "TaxSta", 1,0, true, "税收居民身份" )))
					.addNode(new FieldNode("MobiT1", new MsgField(ContentEnum.MessageType.STRING.toString(), "MobiT1", 20,0, false, "手机号码1" )))
					...
					.addNode(new FieldNode("DSumhn", new MsgField(ContentEnum.MessageType.INT.toString(), "DSumhn", 18,2, false, "日累计限额" )))
					.addNode(new FieldNode("Trankh", new MsgField(ContentEnum.MessageType.STRING.toString(), "Trankh", 1,0, false, "跨行转账" )))
					.addNode(new FieldNode("DSumkh", new MsgField(ContentEnum.MessageType.INT.toString(), "DSumkh", 18,2, false, "日累计限额(跨行)" )))
	...
	public static class C012000110_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
