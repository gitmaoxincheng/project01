...
@Component
public class BODAFA0001 extends EciChannelService {

	private static BODAFA0001_I i = new BODAFA0001_I();
	private static BODAFA0001_O o = new BODAFA0001_O();
	public BODAFA0001 () {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODAFA0001_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("checkpwdmode", new MsgField(ContentEnum.MessageType.STRING.toString(), "checkpwdmode", 06,0, false, "支持验密方式" )))
					.addNode(new FieldNode("passwd", new MsgField(ContentEnum.MessageType.STRING.toString(), "passwd", 64,0, false, "密码" )))
					.addNode(new FieldNode("manfttype", new MsgField(ContentEnum.MessageType.STRING.toString(), "manfttype", 01,0, false, "厂商类型" )))
					.addNode(new FieldNode("strfinger", new MsgField(ContentEnum.MessageType.STRING.toString(), "strfinger", 10,0, false, "指纹序号" )))
					.addNode(new FieldNode("dactylogram", new MsgField(ContentEnum.MessageType.STRING.toString(), "dactylogram", 06,0, false, "指纹信息" )))
					.addNode(new FieldNode("isylcomd", new MsgField(ContentEnum.MessageType.STRING.toString(), "isylcomd", 01,0, false, "是否由前置硬加密" )))
					.addNode(new FieldNode("token", new MsgField(ContentEnum.MessageType.STRING.toString(), "token", 16,0, false, "令牌" )))
	...
	public static class BODAFA0001_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("info", new MsgField(ContentEnum.MessageType.STRING.toString(), "info", 60,0, false, "公告信息" )))
