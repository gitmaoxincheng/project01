 ...
 * json报文
 */
public class EsbIcaChannelService extends IOService {
...
/*			esbheadStruct.addNode(new FieldNode("SrcIP1", new MsgField(ContentEnum.MessageType.STRING.toString(), "SrcIP1", 128, 0, false, "源请求方服务器IP")));  // ESB系统虽定义，但未使用，需严格按照接口定义上传
	...
	public static class EsbHeaderO extends MsgHeader {
		...
		private  MsgSegment init() {
			...
			esbheadStruct.addNode(new FieldNode("TellerNo", new MsgField(ContentEnum.MessageType.STRING.toString(), "TellerNo", 10, 0, false, "柜员号")));
			esbheadStruct.addNode(new FieldNode("TellerTp", new MsgField(ContentEnum.MessageType.STRING.toString(), "TellerTp", 1, 0, false, "柜员类别")));
			esbheadStruct.addNode(new FieldNode("BrNo", new MsgField(ContentEnum.MessageType.STRING.toString(), "BrNo", 8, 0, false, "机构号")));
			esbheadStruct.addNode(new FieldNode("ZoneNo", new MsgField(ContentEnum.MessageType.STRING.toString(), "ZoneNo", 8, 0, false, "分行号")));
			esbheadStruct.addNode(new FieldNode("MyBank", new MsgField(ContentEnum.MessageType.STRING.toString(), "MyBank", 3, 0, false, "法人号")));
	...
	public static class AppHeaderI extends MsgHeader {
		...
		private  MsgSegment init() {
			...
			headStruct.addNode(new FieldNode("txn_code", new MsgField(ContentEnum.MessageType.STRING.toString(), "txn_code", 20, 0, true, "交易码")))//txn_code由 原子服务表记录
					  ...
					  .addNode(new FieldNode("seal_vrfcn_rslt", new MsgField(ContentEnum.MessageType.STRING.toString(), "seal_vrfcn_rslt", 10, 0, false, "验印结果")))
					  ...
					  .addNode(new ArrayNode("dalrinfo_obj",false)
							.addNode(new FieldNode("agnt_docs_catg", new MsgField(ContentEnum.MessageType.STRING.toString(), "agnt_docs_catg", 3, 0, false, "代理人证件类型")))
  							...
  							.addNode(new FieldNode("agnt_term_val", new MsgField(ContentEnum.MessageType.STRING.toString(), "agnt_term_val", 8, 0, false, "代理人证件有效期")))
  							.addNode(new FieldNode("agnt_nm", new MsgField(ContentEnum.MessageType.STRING.toString(), "agnt_nm", 256, 0, false, "消息处理方法")))
  							.addNode(new FieldNode("agnt_sexual", new MsgField(ContentEnum.MessageType.STRING.toString(), "agnt_sexual", 2, 0, false, "代理人性别")))
  							...
  							.addNode(new FieldNode("agnt_remks_info", new MsgField(ContentEnum.MessageType.STRING.toString(), "agnt_remks_info", 300, 0, false, "代理人备注信息")))
  							  )
					  ;
			messageNode.addStructNode(headStruct);
			return messageNode;
	...
	public static class AppHeaderO extends MsgHeader {
		...
		private  MsgSegment init() {
			...
			headStruct.addNode(new FieldNode("totl_cnt_num", new MsgField(ContentEnum.MessageType.INT.toString(), "totl_cnt_num", 10, 0, false, "总笔数")))
					  ...
					  .addNode(new ArrayNode("cjsfsvrlst_list")//场景收费服务列表
	  							...
	  							.addNode(new FieldNode("fee_rcvbl_amt", new MsgField(ContentEnum.MessageType.AMOUNT.toString(), "fee_rcvbl_amt", 18, 2, false, "标准收费金额")))
	  							.addNode(new FieldNode("rcvbl_amt", new MsgField(ContentEnum.MessageType.AMOUNT.toString(), "rcvbl_amt", 18, 2, false, "应收金额")))
	  							.addNode(new FieldNode("pref_pcnt", new MsgField(ContentEnum.MessageType.DECIMALS.toString(), "pref_pcnt", 18, 2, false, "优惠比例")))
	  							.addNode(new FieldNode("pref_amt", new MsgField(ContentEnum.MessageType.AMOUNT.toString(), "pref_amt", 18, 2, false, "优惠金额")))
	  						  )					  
					  ;
		messageNode.addStructNode(headStruct);
			return messageNode;
