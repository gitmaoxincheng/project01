...
/**
 * BASESVC.P011000901 存款产品购买.大额存单认购 
 * P0110009.01 dp2265
 * 0005 新核心系统
 * @author XZF
 */
@Component
public class P011000901 extends EsbCoreChannelService {

	private static P011000901_I i = new P011000901_I();
	private static P011000901_O o = new P011000901_O();
	public P011000901() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class P011000901_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true)
					...
					.addNode(new FieldNode("newly_open_cust_acct_num_flg", new MsgField(ContentEnum.MessageType.STRING.toString(), "newly_open_cust_acct_num_flg", 1,0, true, "新开客户账号标志" )))
					...
					.addNode(new FieldNode("pymt_sub_acct_serl_num", new MsgField(ContentEnum.MessageType.STRING.toString(), "pymt_sub_acct_serl_num", 8,0, true, "付款子账户序号" )))
					...
					.addNode(new FieldNode("pref_val", new MsgField(ContentEnum.MessageType.INT.toString(), "pref_val", 18,2, false, "优惠值" )))
	...
	public static class P011000901_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
