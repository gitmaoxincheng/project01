...
/**
 * BASESVC BODAFA0047  新增客户签约 
 *  BODAFA0047 884002
 *  综合前置
 * @author XZF
 */
@Component
public class BODAFA0047 extends EciChannelService {

	private static BODAFA0047_I i = new BODAFA0047_I();
	private static BODAFA0047_O o = new BODAFA0047_O();
	public BODAFA0047() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODAFA0047_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("vouhno", new MsgField(ContentEnum.MessageType.STRING.toString(), "vouhno", 32,0, false, "凭证号" )))
					.addNode(new FieldNode("acctno", new MsgField(ContentEnum.MessageType.STRING.toString(), "acctno", 32,0, false, "签约卡号" )))
					...
					.addNode(new FieldNode("payflag", new MsgField(ContentEnum.MessageType.STRING.toString(), "payflag", 1,0, false, "是否由付费帐号统一付费" )))
					...
					.addNode(new FieldNode("phone", new MsgField(ContentEnum.MessageType.STRING.toString(), "phone", 120,0, false, "用户号" )))
					.addNode(new FieldNode("intram", new MsgField(ContentEnum.MessageType.STRING.toString(), "intram", 18,0, false, "单笔转入限额" )))
					.addNode(new FieldNode("outram", new MsgField(ContentEnum.MessageType.STRING.toString(), "outram", 18,0, false, "单笔转出限额" )))
					...
					.addNode(new FieldNode("dknote", new MsgField(ContentEnum.MessageType.STRING.toString(), "dknote", 1,0, false, "通知类型" )))
	...
	public static class BODAFA0047_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
