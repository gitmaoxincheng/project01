...
/**
 * BASESVC.C023000401 签约信息查询.统一签约申请信息查询 
 * C0230004.01 8819712
 * 0339 综合前置(微网点模块)
 * @author XZF
 */
@Component
public class C023000401 extends EsbChannelService {

	private static C023000401_I i = new C023000401_I();
	private static C023000401_O o = new C023000401_O();
	public C023000401() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class C023000401_I extends MsgBody {
	...
	public static class C023000401_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
					.addNode(new ArrayNode("ApplyInfo",false)
							...
							.addNode(new FieldNode("Keycha", new MsgField(ContentEnum.MessageType.STRING.toString(), "Keycha", 1,0, false, "KEY渠道" )))
