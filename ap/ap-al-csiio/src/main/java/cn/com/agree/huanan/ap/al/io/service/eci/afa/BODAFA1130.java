...
/**
 * BASESVC BODAFA1130  个人购汇信息录入 
 *  BODAFA1130 8810915
 *  综合前置
 * @author    XZF
 */
@Component
public class BODAFA1130 extends EciChannelService {

	private static BODAFA1130_I i = new BODAFA1130_I();
	private static BODAFA1130_O o = new BODAFA1130_O();
	...
	public static class BODAFA1130_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("purfx_type_code", new MsgField(ContentEnum.MessageType.STRING.toString(), "purfx_type_code", 4,0, false, "购汇资金属性" )))
					.addNode(new FieldNode("txccy", new MsgField(ContentEnum.MessageType.STRING.toString(), "txccy", 3,0, false, "币种" )))
					.addNode(new FieldNode("purfx_amt", new MsgField(ContentEnum.MessageType.STRING.toString(), "purfx_amt", 20,0, false, "购汇金额" )))
					.addNode(new FieldNode("purfx_cash_amt", new MsgField(ContentEnum.MessageType.STRING.toString(), "purfx_cash_amt", 20,0, false, "购汇提钞金额" )))
					.addNode(new FieldNode("fcy_remit_amt", new MsgField(ContentEnum.MessageType.STRING.toString(), "fcy_remit_amt", 20,0, false, "汇出资金（包括外汇票据）金额" )))
					.addNode(new FieldNode("fcy_acct_amt", new MsgField(ContentEnum.MessageType.STRING.toString(), "fcy_acct_amt", 20,0, false, "存入个人外汇账户金额" )))
					.addNode(new FieldNode("tchk_amt", new MsgField(ContentEnum.MessageType.STRING.toString(), "tchk_amt", 20,0, false, "旅行支票金额" )))
					.addNode(new FieldNode("purfx_acct_cny", new MsgField(ContentEnum.MessageType.STRING.toString(), "purfx_acct_cny", 32,0, false, "购汇人民币账户" )))
					...
					.addNode(new FieldNode("csextg", new MsgField(ContentEnum.MessageType.STRING.toString(), "csextg", 1,0, false, "汇抄标识" )))
					...
					.addNode(new FieldNode("purpose", new MsgField(ContentEnum.MessageType.STRING.toString(), "purpose", 200,0, false, "购汇用途" )))
					.addNode(new FieldNode("yjghtime", new MsgField(ContentEnum.MessageType.STRING.toString(), "yjghtime", 200,0, false, "预计用汇时间" )))
					.addNode(new FieldNode("exinfo1", new MsgField(ContentEnum.MessageType.STRING.toString(), "exinfo1", 300,0, false, "附加信息1" )))
					.addNode(new FieldNode("exinfo2", new MsgField(ContentEnum.MessageType.STRING.toString(), "exinfo2", 300,0, false, "附加信息2" )))
					.addNode(new FieldNode("exinfo3", new MsgField(ContentEnum.MessageType.STRING.toString(), "exinfo3", 300,0, false, "附加信息3" )))
					.addNode(new FieldNode("exinfo4", new MsgField(ContentEnum.MessageType.STRING.toString(), "exinfo4", 300,0, false, "附加信息4" )))
					.addNode(new FieldNode("exinfo5", new MsgField(ContentEnum.MessageType.STRING.toString(), "exinfo5", 300,0, false, "附加信息5" )))
					...
					.addNode(new FieldNode("excrate", new MsgField(ContentEnum.MessageType.STRING.toString(), "excrate", 18,0, false, "牌价" )))
					.addNode(new FieldNode("projtg", new MsgField(ContentEnum.MessageType.STRING.toString(), "projtg", 20,0, false, "外管统计代码" )))
					.addNode(new FieldNode("crcycd", new MsgField(ContentEnum.MessageType.STRING.toString(), "crcycd", 3,0, false, "币种" )))
					.addNode(new FieldNode("tocsex", new MsgField(ContentEnum.MessageType.STRING.toString(), "tocsex", 1,0, false, "汇抄标识" )))
	...
	public static class BODAFA1130_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("purfx_amt_usd", new MsgField(ContentEnum.MessageType.STRING.toString(), "purfx_amt_usd", 20,0, false, "本次购汇金额折美元" )))
					.addNode(new FieldNode("ann_rem_fcyamt_usd", new MsgField(ContentEnum.MessageType.STRING.toString(), "ann_rem_fcyamt_usd", 20,0, false, "本年额度内剩余可购汇金额折美元" )))
					.addNode(new FieldNode("type_status", new MsgField(ContentEnum.MessageType.STRING.toString(), "type_status", 2,0, false, "个人主体分类状态代码" )))
