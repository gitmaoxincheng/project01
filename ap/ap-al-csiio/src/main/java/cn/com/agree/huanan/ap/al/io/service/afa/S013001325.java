...
/**
 * BASESVC.S013001325 柜员机构信息查询.	柜员日终签退待办事项查询 
 * S0130013.25 005022
 * 0000 柜员管理
 * @author JZF
 */
@Component
public class S013001325 extends EsbChannelService {
	/*
...
('BASESVCS013001325', 'BASESVC', '柜员管理', 'S013001325', '柜员机构信息查询', 'ESB', 'ESB_afa系统', 'S0130013', '	柜员日终签退待办事项查询', '25','005022' ,'柜员机构信息查询', '1', '0', '柜员机构信息查询');

	 */
	private static S013001325_I i = new S013001325_I();
	private static S013001325_O o = new S013001325_O();
	...
	public static class S013001325_I extends MsgBody {
	...
	public static class S013001325_O extends MsgBody {
		private MsgSegment msgSegment = init();
