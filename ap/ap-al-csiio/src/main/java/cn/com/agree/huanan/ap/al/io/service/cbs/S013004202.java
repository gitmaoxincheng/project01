...
/**
 * BASESVC.S013004202 凭证使用信息查询.作废销毁凭证清单查询 
 * S0130042.02 ce5199
 * 0005 新核心业务系统
 * @author zhonggp
 */
@Component
public class S013004202 extends EsbCoreChannelService {

	
	private static S013004202_I i = new S013004202_I();
	private static S013004202_O o = new S013004202_O();
	...
	public static class S013004202_I extends MsgBody {
	...
	public static class S013004202_O extends MsgBody {
		private MsgSegment msgSegment = init();
