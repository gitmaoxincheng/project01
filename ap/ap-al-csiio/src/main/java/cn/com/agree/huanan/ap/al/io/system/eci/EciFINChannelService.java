	...
	public static class Ctrl_I extends MsgHeader {
		...
		private  MsgSegment init() {
			...
			ctrlStruct
				...
				.addNode(new FieldNode("termno", new MsgField(ContentEnum.MessageType.STRING.toString(), "termno", 3,0, false, "交易终端" )))
				.addNode(new FieldNode("Channel", new MsgField(ContentEnum.MessageType.STRING.toString(), "Channel", 3,0, false, "交易渠道" )))
				.addNode(new FieldNode("transtype", new MsgField(ContentEnum.MessageType.STRING.toString(), "transtype", 1,0, false, "业务类型" )))
