...
/**
 * BASESVC BODDGT6022  东莞通预充值圈存冲正 
 *  BODDGT6022 8810003
 *  东莞通系统
 * @author XZF
 */
@Component
public class BODDGT6022 extends EciChannelService {

	private static BODDGT6022_I i = new BODDGT6022_I();
	private static BODDGT6022_O o = new BODDGT6022_O();
	public BODDGT6022() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODDGT6022_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("Tra_LastPosSvSeq", new MsgField(ContentEnum.MessageType.STRING.toString(), "Tra_LastPosSvSeq", 9,0, false, "POS终端上笔充值流水号 " )))
					...
					.addNode(new FieldNode("Tra_QueryPreSeq", new MsgField(ContentEnum.MessageType.STRING.toString(), "Tra_QueryPreSeq", 18,0, false, "查询预充值余额时" )))
	...
	public static class BODDGT6022_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
