...
/**
 * BASESVC.S012000516 柜员信息管理.柜员日终签退 
 * S0120005.16 exitus
 * 0009 大总账
 * @author XZF
 */
@Component
public class S012000516 extends EsbGlsChannelService {

	private static S012000516_I i = new S012000516_I();
	private static S012000516_O o = new S012000516_O();
	public S012000516() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class S012000516_I extends MsgBody {
	...
	public static class S012000516_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
