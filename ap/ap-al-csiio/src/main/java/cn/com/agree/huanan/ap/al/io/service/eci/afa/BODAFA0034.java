 ...
 * 
 * @author zhuzc
 * BASESVC BODAFA0034 贷记卡取款冲正
 * BODAFA0034 883006
 * ATM
 */
@Component
public class BODAFA0034 extends EciChannelService{
	private static BODAFA0034_I i = new BODAFA0034_I();
	private static BODAFA0034_O o = new BODAFA0034_O();
	public BODAFA0034() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODAFA0034_I extends MsgBody {
	...
	public static class BODAFA0034_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
