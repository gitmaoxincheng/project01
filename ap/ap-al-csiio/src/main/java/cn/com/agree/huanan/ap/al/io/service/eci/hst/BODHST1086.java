...
/**
 * BASESVC BODHST1086  单位账户信息综合查询(明细查询) 
 *  BODHST1086 
 *  旧核心系统
 * @author XZF
 */
@Component
public class BODHST1086 extends EciChannelService {

	private static BODHST1086_I i = new BODHST1086_I();
	private static BODHST1086_O o = new BODHST1086_O();
	public BODHST1086() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODHST1086_I extends MsgBody {
	...
	public static class BODHST1086_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("ioshtg", new MsgField(ContentEnum.MessageType.STRING.toString(), "ioshtg", 25,0, false, "表内外标志" )))
					...
					.addNode(new FieldNode("instrt", new MsgField(ContentEnum.MessageType.STRING.toString(), "instrt", 16,0, false, "利率" )))
					...
					.addNode(new FieldNode("debtcd", new MsgField(ContentEnum.MessageType.STRING.toString(), "debtcd", 8,0, false, "储种代码" )))
					...
					.addNode(new FieldNode("fnpdid", new MsgField(ContentEnum.MessageType.STRING.toString(), "fnpdid", 20,0, false, "产品代码" )))
					.addNode(new FieldNode("fnpdtp", new MsgField(ContentEnum.MessageType.STRING.toString(), "fnpdtp", 25,0, false, "产品种类" )))
					.addNode(new FieldNode("custtp", new MsgField(ContentEnum.MessageType.STRING.toString(), "custtp", 16,0, false, "客户类型" )))
					.addNode(new FieldNode("custcl", new MsgField(ContentEnum.MessageType.STRING.toString(), "custcl", 3,0, false, "取客户级别" )))
					.addNode(new FieldNode("dcmttp", new MsgField(ContentEnum.MessageType.STRING.toString(), "dcmttp", 6,0, false, "凭证类型" )))
					.addNode(new FieldNode("dcmtno", new MsgField(ContentEnum.MessageType.STRING.toString(), "dcmtno", 34,0, false, "凭证号码" )))
					.addNode(new FieldNode("dcmtst", new MsgField(ContentEnum.MessageType.STRING.toString(), "dcmtst", 100,0, false, "凭证状态" )))
					...
					.addNode(new FieldNode("closdt", new MsgField(ContentEnum.MessageType.STRING.toString(), "closdt", 3,0, false, "销户日期" )))
					...
					.addNode(new FieldNode("acctst_new", new MsgField(ContentEnum.MessageType.STRING.toString(), "acctst_new", 24,0, false, "账户状态" )))
					);
			return messageNode;
		}
		@Override
