...
/**
 * BASESVC BODF510001  新单承保 
 *  BODF510001 regflw
 *  综合前置
 * @author XZF
 */
@Component
public class BODF510001 extends EciFINChannelService {

	private static BODF510001_I i = new BODF510001_I();
	private static BODF510001_O o = new BODF510001_O();
	public BODF510001() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODF510001_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("tbrdwmc", new MsgField(ContentEnum.MessageType.STRING.toString(), "tbrdwmc", 200,0, false, "投保人工作单位" )))
					...
					.addNode(new ArrayNode("syr_list",false,"syr")
					...
					.addNode(new ArrayNode("fjxlb_list",false,"fjxlb")
	...
	public static class BODF510001_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
