...
@Component
public class BODECIF0002 extends EciChannelService{
	private static BODECIF0002_I i = new BODECIF0002_I();
	private static BODECIF0002_O o = new BODECIF0002_O();
	public BODECIF0002() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODECIF0002_I extends MsgBody {
	...
	public static class BODECIF0002_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					
					.addNode(new FieldNode("Eciorgbuf", new MsgField(ContentEnum.MessageType.STRING.toString() , "Eciorgbuf",	1024	,0, false, "渠道备注?息" )))
