...
/**
 * BASESVC BODAFA1659  回单机解约 
 *  BODAFA1659 8815702
 *  综合前置
 * @author XZF
 */
@Component
public class BODAFA1659 extends EciChannelService {

	private static BODAFA1659_I i = new BODAFA1659_I();
	private static BODAFA1659_O o = new BODAFA1659_O();
	public BODAFA1659() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODAFA1659_I extends MsgBody {
	...
	public static class BODAFA1659_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
