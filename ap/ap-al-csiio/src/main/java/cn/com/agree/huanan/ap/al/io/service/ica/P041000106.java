...
/**
 * BASESVC.P041000106 ATM指定账户圈存 
 * P0410001.06 icazqc 关联接口所属系统：

 * 0050 IC卡系统2.0
 * @author XZF
 */
@Component
public class P041000106 extends EsbChannelService {

	private static P041000106_I i = new P041000106_I();
	private static P041000106_O o = new P041000106_O();
	public P041000106() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class P041000106_I extends MsgBody {
	...
	public static class P041000106_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
