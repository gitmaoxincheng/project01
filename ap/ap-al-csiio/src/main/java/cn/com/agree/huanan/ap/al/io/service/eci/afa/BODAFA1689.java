...
/**
 * BASESVC BODAFA1689  柜员间贷记卡调入 
 *  BODAFA1689 883747
 *  综合前置
 * @author LSJ
 */
@Component
public class BODAFA1689 extends EciChannelService {

	private static BODAFA1689_I i = new BODAFA1689_I();
	private static BODAFA1689_O o = new BODAFA1689_O();
	public BODAFA1689() {
        requestFormat.add(i);
        responseFormat.add(o);
	}

	public static class BODAFA1689_I extends MsgBody {
	...
	public static class BODAFA1689_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
