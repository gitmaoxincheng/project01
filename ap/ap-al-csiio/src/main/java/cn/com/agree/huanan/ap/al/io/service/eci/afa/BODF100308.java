...
/**
 * BASESVC BODF100308  客户历史委托查询交易 
 *  BODF100308 
 *  综合前端
 * @author XZF
 */
@Component
public class BODF100308 extends EciF10ChannelService {

	private static BODF100308_I i = new BODF100308_I();
	private static BODF100308_O o = new BODF100308_O();
	public BODF100308() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODF100308_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("PrdCode", new MsgField(ContentEnum.MessageType.STRING.toString(), "PrdCode", 30,0, false, "产品代码" )))
					.addNode(new FieldNode("TransCode", new MsgField(ContentEnum.MessageType.STRING.toString(), "TransCode", 30,0, false, "交易代码" )))
					...
					.addNode(new FieldNode("OrderFlag", new MsgField(ContentEnum.MessageType.STRING.toString(), "OrderFlag", 1,0, true, "排序标志" )))
					...
					.addNode(new FieldNode("BidFlag", new MsgField(ContentEnum.MessageType.STRING.toString(), "BidFlag", 1,0, false, "招投表产品标志" )))
	...
	public static class BODF100308_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("OffSet", new MsgField(ContentEnum.MessageType.STRING.toString(), "OffSet", 50,0, true, "定位串" )))
					.addNode(new ArrayNode("bodrcd",true,"his_tran_list")
							...
							.addNode(new FieldNode("ErrCode", new MsgField(ContentEnum.MessageType.STRING.toString(), "ErrCode", 10,0, true, "错误代码" )))
							...
							.addNode(new FieldNode("TransAccount", new MsgField(ContentEnum.MessageType.STRING.toString(), "TransAccount", 20,0, true, "交易介质" )))
							...
							.addNode(new FieldNode("ContractNo", new MsgField(ContentEnum.MessageType.STRING.toString(), "ContractNo", 10,0, true, "合约编号" )))
							...
							.addNode(new FieldNode("AssoSerial", new MsgField(ContentEnum.MessageType.STRING.toString(), "AssoSerial", 10,0, false, "关联流水号" )))
							...
							.addNode(new FieldNode("OriExSerial", new MsgField(ContentEnum.MessageType.STRING.toString(), "OriExSerial", 10,0, true, "原发起方流水号" )))
							));
			return messageNode;
		}
		@Override
