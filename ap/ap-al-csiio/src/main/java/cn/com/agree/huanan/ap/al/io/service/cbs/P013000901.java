...
/**
 * BASESVC.P013000901 回单查询
 * P0130009.01 br5376
 * 0005 新核心系统
 * @author YFK
 */
@Component
public class P013000901 extends EsbCoreChannelService{

	private static P013000901_I i = new P013000901_I();
	private static P013000901_O o = new P013000901_O();
	public P013000901() {
		requestFormat.add(i);
		responseFormat.add(o);
	}
	
	public static class P013000901_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true)
					...
					.addNode(new FieldNode("cntpr_cust_acct_num", new MsgField(ContentEnum.MessageType.STRING.toString(), "cntpr_cust_acct_num" , 40,0, false, "交易对手账号  " )))
	...
	public static class P013000901_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
							...
							.addNode(new FieldNode("tlr_rung_num",new MsgField(ContentEnum.MessageType.STRING.toString(),"tlr_rung_num" ,64,0, false, "柜员流水号号" )))
							.addNode(new FieldNode("txn_code",new MsgField(ContentEnum.MessageType.STRING.toString(),"txn_code" ,20,0, false, "交易码" )))
							.addNode(new FieldNode("txn_nm",new MsgField(ContentEnum.MessageType.STRING.toString(),"txn_nm" ,1,500,false, "交易名称" )))
