...
/**
 * BASESVC BODCAP0037  网申发卡同时分期 
 *  BODCAP0037 ar4140
 *  贷记卡审批系统
 * @author guyulong
 */
@Component
public class BODCAP0037 extends EciChannelService {

	private static BODCAP0037_I i = new BODCAP0037_I();
	private static BODCAP0037_O o = new BODCAP0037_O();
	public BODCAP0037() {
        requestFormat.add(i);
        responseFormat.add(o);
	}

	public static class BODCAP0037_I extends MsgBody {
...
.addNode(new FieldNode("id_expired_date", new MsgField(ContentEnum.MessageType.STRING.toString(), "id_expired_date", 8,0, true, "证件有效期" )))
...
.addNode(new FieldNode("birth_date", new MsgField(ContentEnum.MessageType.STRING.toString(), "birth_date", 8,0, true, "出生日期" )))
...
.addNode(new FieldNode("regular_cust_type", new MsgField(ContentEnum.MessageType.STRING.toString(), "regular_cust_type", 20,0, false, "我行客户关系" )))
...
.addNode(new FieldNode("company_income", new MsgField(ContentEnum.MessageType.STRING.toString(), "company_income", 5,0, false, "年薪（万）" )))
...
.addNode(new FieldNode("cont_1_mobile_no", new MsgField(ContentEnum.MessageType.STRING.toString(), "cont_1_mobile_no", 12,0, true, "直系亲属手机号码" )))
...
.addNode(new FieldNode("cont_2_mobile_no", new MsgField(ContentEnum.MessageType.STRING.toString(), "cont_2_mobile_no", 12,0, true, "紧急联系人手机号码" )))
...
.addNode(new FieldNode("fms_ind", new MsgField(ContentEnum.MessageType.STRING.toString(), "fms_ind", 1,0, true, "银信通服务" )))
...
.addNode(new FieldNode("other_loancard_total_limit", new MsgField(ContentEnum.MessageType.STRING.toString(), "other_loancard_total_limit", 21,0, false, "总额度是多少" )))
...
.addNode(new FieldNode("issigned", new MsgField(ContentEnum.MessageType.STRING.toString(), "issigned", 1,0, true, "申请表是否有客户签名" )))
.addNode(new FieldNode("ishad_appl_date", new MsgField(ContentEnum.MessageType.STRING.toString(), "ishad_appl_date", 1,0, true, "申请表是否写申请时间" )))
...
.addNode(new FieldNode("pass_check_ind", new MsgField(ContentEnum.MessageType.STRING.toString(), "pass_check_ind", 1,0, true, "刷卡设置" )))
...
.addNode(new FieldNode("autopay_ind", new MsgField(ContentEnum.MessageType.STRING.toString(), "autopay_ind", 1,0, true, "自动还款标识" )))
...
.addNode(new FieldNode("identity_type", new MsgField(ContentEnum.MessageType.STRING.toString(), "identity_type", 10,0, false, "身份类型" )))
...
.addNode(new FieldNode("request_ipp_amount", new MsgField(ContentEnum.MessageType.STRING.toString(), "request_ipp_amount", 21,0, false, "分期额度" )))
.addNode(new FieldNode("period_id", new MsgField(ContentEnum.MessageType.STRING.toString(), "period_id", 11,0, false, "分期期数" )))
...
.addNode(new FieldNode("payee_acct_no", new MsgField(ContentEnum.MessageType.STRING.toString(), "payee_acct_no", 120,0, false, "收款账号" )))
...
.addNode(new FieldNode("ipp_project_id", new MsgField(ContentEnum.MessageType.STRING.toString(), "ipp_project_id", 20,0, false, "分期项目代码" )))
.addNode(new FieldNode("ipp_purpose", new MsgField(ContentEnum.MessageType.STRING.toString(), "ipp_purpose", 20,0, false, "分期用途" )))
.addNode(new FieldNode("appl_date", new MsgField(ContentEnum.MessageType.STRING.toString(), "appl_date", 8,0, true, "申请日期" )))
.addNode(new FieldNode("accept_brch_ids", new MsgField(ContentEnum.MessageType.STRING.toString(), "accept_brch_ids", 40,0, false, "受理网点" )))
...
.addNode(new FieldNode("recommand_brch_no", new MsgField(ContentEnum.MessageType.STRING.toString(), "recommand_brch_no", 10,0, false, "推荐人机构号" )))
);
			return messageNode;
		}
		@Override
	...
	public static class BODCAP0037_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
