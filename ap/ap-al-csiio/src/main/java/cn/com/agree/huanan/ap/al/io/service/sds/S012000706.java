...
/**
 * BASESVC.S012000706 集中作业管理.移动营销集中审核 
 * S0120007.06 CentAuDi
 * 0209 集中业务处理平台
 * @author XZF
 */
@Component
public class S012000706 extends EsbSdsChannelService {

	private static S012000706_I i = new S012000706_I();
	private static S012000706_O o = new S012000706_O();
	public S012000706() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class S012000706_I extends MsgBody {
	...
	public static class S012000706_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
