...
/**
 * BASESVC.C012000505 客户基本信息维护.个人客户开户证件信息修改 
 * C0120005.05 ECIF305
 * 0337 企业级客户信息管理系统
 * @author STJ
 */
@Component
public class C012000505 extends EsbChannelService {
	/*
...
('BASESVCC012000505', 'BASESVC', '企业级客户信息管理系统', 'C012000505', '客户基本信息维护', 'ENC', 'ESB_enc系统', 'C0120005', '个人客户开户证件信息修改', '05','ECIF305' ,'客户基本信息维护', '1', '0', '客户基本信息维护');

	 */
	private static C012000505_I i = new C012000505_I();
	private static C012000505_O o = new C012000505_O();
	...
	public static class C012000505_I extends MsgBody {
			...
			messageNode.addStructNode(new StructNode("APPBody",true)
					.addNode(new ArrayNode("custinfo",false)
							...
							.addNode(new FieldNode("countryorregion", new MsgField(ContentEnum.MessageType.STRING.toString(), "countryorregion", 3,0, false, "国籍或地区" )))
									...
									.addNode(new FieldNode("enterscale", new MsgField(ContentEnum.MessageType.STRING.toString(), "enterscale", 2,0, false, "企业规模（行内标准）" )))
									...
									.addNode(new FieldNode("deptflag", new MsgField(ContentEnum.MessageType.STRING.toString(), "deptflag", 20,0, false, "存款人类别" )))
									...
									.addNode(new FieldNode("direacctseq", new MsgField(ContentEnum.MessageType.STRING.toString(), "direacctseq", 20,0, false, "主管单位基本账户编号" )))
									...
									.addNode(new FieldNode("orgenaddrna", new MsgField(ContentEnum.MessageType.STRING.toString(), "orgenaddrna", 120,0, false, "单位地址-国家（英文或拼音）" )))
									.addNode(new FieldNode("orgenaddrpr", new MsgField(ContentEnum.MessageType.STRING.toString(), "orgenaddrpr", 120,0, false, "单位地址-省（英文或拼音）" )))
									.addNode(new FieldNode("orgenaddrct", new MsgField(ContentEnum.MessageType.STRING.toString(), "orgenaddrct", 120,0, false, "单位地址-市（英文或拼音）" )))
									.addNode(new FieldNode("orgenaddrzn", new MsgField(ContentEnum.MessageType.STRING.toString(), "orgenaddrzn", 120,0, false, "单位地址-区（英文或拼音）" )))
	...
	public static class C012000505_O extends MsgBody {
		private MsgSegment msgSegment = init();
