...
/**
 * BASESVC BODF100202  理财产品赎回交易 
 *  BODF100202 regflw
 *  综合前置
 * @author XZF
 */
@Component
public class BODF100202 extends EciF10ChannelService {

	private static BODF100202_I i = new BODF100202_I();
	private static BODF100202_O o = new BODF100202_O();
	public BODF100202() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODF100202_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("LargRedFlag", new MsgField(ContentEnum.MessageType.STRING.toString(), "LargRedFlag", 1,0, true, "巨额赎回处理标志" )))
					.addNode(new FieldNode("CfmNo", new MsgField(ContentEnum.MessageType.STRING.toString(), "CfmNo", 30,0, false, "原确认流水号" )))
	...
	public static class BODF100202_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
			.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("Agio", new MsgField(ContentEnum.MessageType.STRING.toString(), "Agio", 17,0, false, "折扣率" )))
					.addNode(new FieldNode("LargRedFlag", new MsgField(ContentEnum.MessageType.STRING.toString(), "LargRedFlag", 1,0, true, "巨额赎回处理标志" )))
					.addNode(new FieldNode("ClientManager", new MsgField(ContentEnum.MessageType.STRING.toString(), "ClientManager", 10,0, false, "客户经理代码代码" )))
