...
/**
 * BASESVC.P045000102 ATM指定账户圈存冲正 
 * P0450001.01 icazwc
 * 0050 IC卡系统2.0
 * @author XZF
 */
@Component
public class P045000102 extends EsbChannelService {

	private static P045000102_I i = new P045000102_I();
	private static P045000102_O o = new P045000102_O();
	public P045000102() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class P045000102_I extends MsgBody {
	...
	public static class P045000102_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
