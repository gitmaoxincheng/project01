...
/**
 * BASESVC BODHST1082   个人账户信息综合查询(列表查询)
 *  BODHST1082 
 *  旧核心系统
 * @author YFK
 */
@Component
public class BODHST1082 extends EciChannelService{

	private static BODHST1082_I i = new BODHST1082_I();
	private static BODHST1082_O o = new BODHST1082_O();
	public BODHST1082() {
		requestFormat.add(i);
		responseFormat.add(o);		
	}
	
	public static class BODHST1082_I extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					.addNode(new FieldNode("Eciorgbuf",new MsgField(ContentEnum.MessageType.STRING.toString(),"Eciorgbuf" ,1024,0, false, "渠道备注信息" )))
					.addNode(new FieldNode("qracno",new MsgField(ContentEnum.MessageType.STRING.toString(),"qracno" ,16,0, false, "卡号" )))
					...
					.addNode(new FieldNode("idtftp",new MsgField(ContentEnum.MessageType.STRING.toString(),"idtftp" ,21,0, false, "证件类别" )))
					.addNode(new FieldNode("idtfno",new MsgField(ContentEnum.MessageType.STRING.toString(),"idtfno" ,21,0, false, "证件号" )))
					.addNode(new FieldNode("rcrdnm",new MsgField(ContentEnum.MessageType.STRING.toString(),"rcrdnm" ,2,0, false, "每页个数" )))
	...
	public static class BODHST1082_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
			...
			.addNode(new FieldNode("aclvtp",new MsgField(ContentEnum.MessageType.STRING.toString(),"aclvtp" ,1,71, false, "账户分类类别" )))
			.addNode(new FieldNode("dcumno",new MsgField(ContentEnum.MessageType.STRING.toString(),"dcumno" ,20,72, false, "凭证号码" )))
			));
			return messageNode;
		}
		@Override
