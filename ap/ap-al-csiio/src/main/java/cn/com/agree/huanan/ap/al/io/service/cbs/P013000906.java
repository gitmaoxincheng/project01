...
/**
 * BASESVC.P013000906 存款账户电子回单打印(批量账户)
 * P013000906
 * br5379 新核心系统
 * @author YFK
 */
@Component
public class P013000906 extends EsbCoreChannelService{

	private static P013000906_I i = new P013000906_I();
	private static P013000906_O o = new P013000906_O();
	public P013000906() {
		requestFormat.add(i);
		responseFormat.add(o);
	}
	public static class P013000906_I extends MsgBody {
	...
	public static class P013000906_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
