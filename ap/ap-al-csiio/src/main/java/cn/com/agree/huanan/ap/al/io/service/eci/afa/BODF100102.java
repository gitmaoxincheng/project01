...
/**
 * BASESVC BODF100102  理财账户登记交易 
 *  BODF100102 
 *  综合前置
 * @author XZF
 */
@Component
public class BODF100102 extends EciF10ChannelService {

	private static BODF100102_I i = new BODF100102_I();
	private static BODF100102_O o = new BODF100102_O();
	public BODF100102() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODF100102_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			messageNode.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("DivMode", new MsgField(ContentEnum.MessageType.STRING.toString(), "DivMode", 17,0, false, "默认分红方式" )))
					.addNode(new FieldNode("DivRate", new MsgField(ContentEnum.MessageType.STRING.toString(), "DivRate", 17,0, false, "红利比例" )))
	...
	public static class BODF100102_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("StatusName", new MsgField(ContentEnum.MessageType.STRING.toString(), "StatusName", 1,0, true, "交易状态名称" )))
