...
/**
 * BASESVC.C022001401 贵金属订单管理.贵金属撤单 
 * C0220014.01 MT0204
 * 0212 金融互联网服务平台
 * @author XZF
 */
@Component
public class C022001401 extends EsbSbcChannelService {

	private static C022001401_I i = new C022001401_I();
	private static C022001401_O o = new C022001401_O();
	public C022001401() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class C022001401_I extends MsgBody {
	...
	public static class C022001401_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
