...
/**
 * BASESVC.S013001322 柜员机构信息查询.柜员未处理事项查询 
 * S0130013.22 qyusunitm
 * 0227 票据系统
 * @author JZF
 */
@Component
public class S013001322 extends EsbChannelService {
	/*
...
('BASESVCS013001322', 'BASESVC', '票据系统', 'S013001322', '柜员机构信息查询', 'ESB', 'ESB_ecd系统', 'S0130013', '柜员未处理事项查询', '22','qyusunitm' ,'柜员机构信息查询', '1', '0', '柜员机构信息查询');

	 */
	private static S013001322_I i = new S013001322_I();
	private static S013001322_O o = new S013001322_O();
	...
	public static class S013001322_I extends MsgBody {
		private MsgSegment msgSegment = init();

		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("APPBody",true)
					.addNode(new FieldNode("strbrno", new MsgField(ContentEnum.MessageType.STRING.toString(), "strbrno", 12,0, true, "机构号" )))
	...
	public static class S013001322_O extends MsgBody {
		private MsgSegment msgSegment = init();
