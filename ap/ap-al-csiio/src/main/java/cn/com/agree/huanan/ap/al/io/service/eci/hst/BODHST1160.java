...
/**
 * BASESVC BODHST1160  月月盈签约 
 *  BODHST1160 
 *  旧核心系统
 * @author XZF
 */
@Component
public class BODHST1160 extends EciChannelService {

	private static BODHST1160_I i = new BODHST1160_I();
	private static BODHST1160_O o = new BODHST1160_O();
	public BODHST1160() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODHST1160_I extends MsgBody {
	...
	public static class BODHST1160_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode.addStructNode(new StructNode("Body",true,"APPBody")
					...
					.addNode(new FieldNode("ot_acctno", new MsgField(ContentEnum.MessageType.STRING.toString(), "ot_acctno", 40,0, false, "转入卡号" )))
