...
/**
 * BASESVC BODF100208  定期定额开通交易 
 *  BODF100208 regflw
 *  综合前置  
 * @author XZF
 */
@Component
public class BODF100208 extends EciF10ChannelService {
	
	private static BODF100208_I i = new BODF100208_I();
	private static BODF100208_O o = new BODF100208_O();
	public BODF100208() {
		requestFormat.add(i);
		responseFormat.add(o);
	}

	public static class BODF100208_I extends MsgBody {
		...
		private MsgSegment init(){
			...
			.addStructNode(new StructNode("APPBody",true,"Body")
					...
					.addNode(new FieldNode("Period", new MsgField(ContentEnum.MessageType.STRING.toString(), "Period", 8,0, true, "投资周期" )))
					...
					.addNode(new FieldNode("StartInvestDate", new MsgField(ContentEnum.MessageType.STRING.toString(), "StartInvestDate", 8,0, false, "定投初始日期" )))
					.addNode(new FieldNode("ClientGroup", new MsgField(ContentEnum.MessageType.STRING.toString(), "ClientGroup", 10,0, true, "客户分组" )))
	...
	public static class BODF100208_O extends MsgBody {
		private MsgSegment  msgSegment = init();
		private MsgSegment init(){
			MsgSegment messageNode = new MsgSegment();
			messageNode
