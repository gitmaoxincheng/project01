package cn.com.agree.hunan.hx.down.advmod.service;
...
import cn.com.agree.hunan.hx.down.advinfo.dao.AdvInfoDao;
import cn.com.agree.hunan.hx.down.advinfo.exception.AdvInfoDataException;
import cn.com.agree.hunan.hx.down.advinfo.po.DevAdv;
import cn.com.agree.hunan.hx.down.advmod.dao.AdvModDao;
import cn.com.agree.hunan.hx.down.advmod.po.AdvMod;
...
public class AdvModService {
	...
	public void addAdvMod(String adtempid, String tempname,String listnm, List<Map<String, String>> advt_list, String tempdesc) {
		...
		for(Map<String , String> map : advt_list) {
			...
			if (am != null) {
				...
				throw new AdvInfoDataException("广告模板表中已存在该广告模板信息,无法新增");
			}
	...
	public void delectAdvMod(String adtempid) {
		...
		if(devAdv != null) {
			...
			throw new AdvInfoDataException("广告发布表中存在该广告模板编号的信息，无法删除");
		}
